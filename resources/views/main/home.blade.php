  ...
  <div class="site-blocks-cover" data-aos="fade">
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start">
            ...
            <p><a href="{{ url('/shop')}}" class="btn btn-black rounded-0">Shop Now</a></p>
            </div>
          </div>
          <div class="col-md-6 order-1 align-self-end">
            <img src="{{ url('assets/images/model_3.png')}}" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          <!--/laravel/paginationProject/storage/app/public/image/1.png-->
    ...
    <div class="site-blocks-cover inner-page py-5" data-aos="fade">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 order-1 align-self-end">
            <img src="{{ url('assets/images/model_6.png')}}" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
